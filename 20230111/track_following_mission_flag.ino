...
void line_tracing()
{
  ...
  switch(index)
  {
    ...
    case -10 : motor_control(1, 80, 120); //직진
               break; 
              
    case 0 : motor_control(1, 80, 120); //직진
             break;
...
{ 
  ...
  {
    motor_control(3,80, 120);
    delay(800);
    motor_control(1, 80, 120);
    delay(1000);
    motor_control(2, 80, 120);
    delay(800);
    motor_control(1, 80, 120);
    delay(1200);
    motor_control(2, 80, 120);
...
void wall_following()
{
  ...
  {
    motor_control(1,60,160);
  }
  if(R_Sonar_Distance > L_Sonar_Distance)
  {
    motor_control(1,120,100);
  }
  if(R_Sonar_Distance = L_Sonar_Distance)
  {
    motor_control(1,80,120);
